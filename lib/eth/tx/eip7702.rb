  ...
  module Tx
    ...
    class Eip7702
      ...
      def initialize(params)
        ...
        @authorizations = fields[:authorizations]
      ...
      def decode(hex)
        ...
        type = hex[0, 2]
        raise TransactionTypeError, "Invalid transaction type #{type}!" if type.to_i(16) != TYPE_7702
      ...
      def unsigned_copy(tx)
        ...
        @authorizations = tx.authorizations.map do |authorization|
      ...
      def encoded
        ...
        authorization_list = @authorizations.map { |authorization| authorization.raw }
      ...
      def unsigned_encoded
        ...
        #TODO make the authorization_list right
        authorization_list = @authorizations.map { |authorization| authorization.encoded }
